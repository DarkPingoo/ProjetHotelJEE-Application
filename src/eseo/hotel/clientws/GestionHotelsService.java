 ...
 * 2018-03-29T17:11:28.752+02:00
 * Generated source version: 2.6.5
 * 
 */
@WebServiceClient(name = "GestionHotelsService", 
                  wsdlLocation = "http://localhost:8085/services/GestionHotelsPort?wsdl",
...
public class GestionHotelsService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8085/services/GestionHotelsPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GestionHotelsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8085/services/GestionHotelsPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
