...
public class GestionHotelsService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:8085/services/GestionHotelsPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GestionHotelsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:8085/services/GestionHotelsPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
